...
namespace Musical_WebStore_BlazorApp.Server.Data.Migrations
{
    ...
    [Migration("20191114214500_ValidDetailsFinal")]
    partial class ValidDetailsFinal
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Musical_WebStore_BlazorApp.Shared.UserLimited", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Musical_WebStore_BlazorApp.Shared.Comment", b =>
                {
                    b.HasOne("Musical_WebStore_BlazorApp.Shared.UserLimited", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });

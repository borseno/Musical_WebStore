...
namespace Musical_WebStore_BlazorApp.Server.Data.Migrations
{
    ...
    [Migration("20191226194828_AddedPurchases")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Musical_WebStore_BlazorApp.Server.Data.Models.ItemOrder", b =>
                {
                    b.Property<int>("InstrumentId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Musical_WebStore_BlazorApp.Server.Data.Models.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            Address = "Харьков, ул. Целиноградская 36б",
                            Name = "Rabbit Coffe Spot (ст. м. Алексеевская)",
                            Phone = "+38(095)233-46-21"
                        },
                        new
                        {
                            Id = -2,
                            Address = "Харьков, Бакулина 45а",
                            Name = "Rabbit Coffe Spot (ст. м. Научная)",
                            Phone = "+38(097)566-53-21"
                        });
                });

            modelBuilder.Entity("Musical_WebStore_BlazorApp.Server.Data.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Musical_WebStore_BlazorApp.Shared.CartItem", b =>
                {
                    b.Property<int>("InstrumentId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Musical_WebStore_BlazorApp.Shared.DTOs.Guitar", b =>
                {
                    b.HasBaseType("Musical_WebStore_BlazorApp.Shared.Instrument");
            ...
            modelBuilder.Entity("Musical_WebStore_BlazorApp.Server.Data.Models.ItemOrder", b =>
                {
                    ...
                    b.HasOne("Musical_WebStore_BlazorApp.Server.Data.Models.Order", "Order")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Musical_WebStore_BlazorApp.Server.Data.Models.Order", b =>
                {
                    b.HasOne("Musical_WebStore_BlazorApp.Server.Data.Models.Location", "Location")
                        .WithMany()
